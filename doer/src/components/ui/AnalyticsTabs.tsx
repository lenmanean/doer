...
export function AnalyticsTabs({
  ...
  return (
    <Card className="bg-[var(--input)] border border-[var(--border)] mb-8">
      {/* Tabs Header */}
          ...
          {activeTab === 'heatmap' && (
            <div>
              ...
              <CardContent className="py-3 px-6 overflow-visible">
                ...
                <div className="mt-6 p-5 bg-[var(--input)] border border-[var(--border)] rounded-lg">
                  <h4 className="text-sm font-semibold text-[var(--foreground)] mb-2">Insights</h4>
