        ...
        <FadeInWrapper>
          <Card>
            ...
            <CardContent className="space-y-8 text-[#d7d2cb]">
              {/* Introduction */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">1. Acceptance of Terms</h2>
                <p className="mb-4">
              ...
              {/* Service Description */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">2. Service Description</h2>
                <p className="mb-4">
              ...
              {/* User Accounts */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">3. User Accounts</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">3.1 Account Creation</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">3.2 Account Eligibility</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">3.3 Account Security</h3>
                <p className="mb-4">
              ...
              {/* Acceptable Use */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">4. Acceptable Use</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">5. Intellectual Property Rights</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">5.1 Our Intellectual Property</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">5.2 Your Content</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">5.3 AI-Generated Content</h3>
                <p className="mb-4">
              ...
              {/* Payment Terms */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">6. Payment Terms</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">6.1 Subscription Plans</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">6.2 Payment Processing</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">6.3 Price Changes</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">6.4 Automatic Renewal</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">6.5 Refunds</h3>
                <p className="mb-4">
              ...
              {/* Termination */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">7. Termination</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">7.1 Termination by You</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">7.2 Termination by Us</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">7.3 Effect of Termination</h3>
                <p className="mb-4">
                  Upon termination:
                </p>
                <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">8. Limitation of Liability</h2>
                <p className="mb-4">
              ...
              {/* Disclaimers */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">9. Disclaimers</h2>
                <p className="mb-4">
              ...
              {/* Dispute Resolution */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">10. Dispute Resolution</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">10.1 Governing Law</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">10.2 Informal Resolution</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">10.3 Binding Arbitration</h3>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">11. Third-Party Services</h2>
                <p className="mb-4">
              ...
              {/* Changes to Terms */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">12. Changes to These Terms</h2>
                <p className="mb-4">
