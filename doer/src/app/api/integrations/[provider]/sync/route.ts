      ...
      for (const calendarId of calendarIds) {
        try {
          ...
          for (const event of fetchResult.events) {
            ...
            // Skip auto-generated Google Calendar events (birthdays, holidays, etc.)
            const isAutoGenerated = isGoogleAutoGeneratedEvent(event, calendarId)
            if (isAutoGenerated) {
              logger.debug('Skipped auto-generated Google Calendar event', {
                eventId: event.id,
