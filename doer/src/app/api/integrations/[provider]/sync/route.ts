        ...
        try {
          ...
          for (const event of fetchResult.events) {
            ...
            if (provider === 'google') {
              ...
              // For Outlook, we need to fetch calendar name if not already available
              // For now, we'll use just the calendarId and event summary
              isAutoGenerated = isOutlookAutoGeneratedEvent(event, calendarId)
            }
