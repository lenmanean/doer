...
/**
 * Generate OAuth authorization URL for Todoist
 * GET /api/integrations/todoist/authorize
 */
export async function GET(request: NextRequest) {
  try {
    ...
    logger.info('Generating OAuth URL for Todoist', {
      redirectUri,
    ...
    logger.error('Failed to generate Todoist OAuth URL', error as Error)
    return NextResponse.json(
