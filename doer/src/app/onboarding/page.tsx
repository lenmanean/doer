...
function OnboardingContent() {
  ...
  // Check if goal was passed from homepage (URL or localStorage) or waitlist
  useEffect(() => {
    ...
    // Only fetch if user is authenticated and no goal found yet
    if (user?.email && !goal.trim()) {
      const fetchWaitlistGoal = async () => {
        try {
          ...
          console.error('Failed to retrieve waitlist goal:', error)
        }
      }
      fetchWaitlistGoal()
    }
  }, [searchParams, user?.email, goal])
