...
function OnboardingContent() {
  ...
  const [userSettings, setUserSettings] = useState<{ allow_weekends?: boolean } | null>(null)
      ...
      <div className="w-full max-w-2xl">
        ...
        >
              ...
              >
                ...
                <CardHeader>
                  {settingsConflict && (
                    <div className="mb-4 rounded-lg border border-orange-500/40 bg-orange-500/10 px-4 py-3 text-left">
