    ...
    <div className="min-h-screen bg-[#0a0a0a] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <FadeInWrapper>
          <Card>
            <CardHeader>
              <CardTitle className="text-3xl mb-2">Responsible Use Policy</CardTitle>
            ...
            <CardContent className="space-y-8 text-[#d7d2cb]">
              {/* Introduction */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">1. Our Commitment to Responsible AI</h2>
                <p className="mb-4">
              ...
              {/* AI Ethics */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">2. AI Ethics and Principles</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">2.1 Human-Centered Design</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">2.2 Transparency and Accountability</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">2.3 Fairness and Non-Discrimination</h3>
                <p className="mb-4">
              ...
              {/* Prohibited Uses */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">3. Prohibited Uses</h2>
                <p className="mb-4">
              ...
              {/* Content Guidelines */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">4. Content Guidelines</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">4.1 Appropriate Content</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">4.2 Professional Use</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">4.3 Content Moderation</h3>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">5. User Responsibilities</h2>
                <p className="mb-4">
                  As a user of DOER, you are responsible for:
                </p>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">5.1 Reviewing AI Output</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">5.2 Ethical Decision-Making</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">5.3 Reporting Issues</h3>
                <p className="mb-4">
                  If you encounter:
                </p>
                <ul className="list-disc pl-6 mb-4 space-y-2">
                ...
                <p className="mb-4">
                  ...
                  <a href="/report-misuse" className="text-orange-500 hover:text-orange-400 underline">
                    Report Misuse
                  </a> form.
                </p>
              </section>
              ...
              {/* AI Limitations */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">6. Understanding AI Limitations</h2>
                <p className="mb-4">
              ...
              {/* Enforcement */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">7. Enforcement</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">8. Reporting Violations</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">9. Continuous Improvement</h2>
                <p className="mb-4">
              ...
              {/* Contact */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">10. Contact Us</h2>
                <p className="mb-4">
