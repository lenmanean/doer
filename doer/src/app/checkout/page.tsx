...
function CheckoutForm() {
  ...
  // Tax preview removed - tax will be calculated at checkout when subscription is created
  // This avoids creating temporary subscriptions in Stripe logs
      ...
      <div className="max-w-6xl mx-auto">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="border-t border-white/10 pt-4 space-y-3">
                  ...
                  {planSlug === 'pro' && (
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-[#d7d2cb]/80">Tax</span>
                      <span className="text-xs text-[#d7d2cb]/60 italic">Calculated at checkout</span>
                    </div>
                  )}
        ...
        {planSlug === 'pro' && billingCycle === 'monthly' && trialEligible !== false && (
          <p className="text-xs text-[#d7d2cb]/60">
            14-day free trial, then {formatPrice(planDetails.priceCents)}/month + tax
          </p>
        )}
                  </div>
                </div>
