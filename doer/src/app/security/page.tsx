    ...
    <div className="min-h-screen bg-[#0a0a0a] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <FadeInWrapper>
          <Card>
            <CardHeader>
              <CardTitle className="text-3xl mb-2">Security</CardTitle>
            ...
            <CardContent className="space-y-8 text-[#d7d2cb]">
              {/* Introduction */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">1. Security Commitment</h2>
                <p className="mb-4">
              ...
              {/* Data Encryption */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">2. Data Encryption</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">2.1 Encryption in Transit</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">2.2 Encryption at Rest</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">2.3 Password Security</h3>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">3. Infrastructure Security</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">3.1 Hosting and Cloud Infrastructure</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">3.2 Network Security</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">3.3 Database Security</h3>
                <p className="mb-4">
              ...
              {/* Access Controls */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">4. Access Controls</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">4.1 User Authentication</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">4.2 Administrative Access</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">4.3 API Security</h3>
                <p className="mb-4">
              ...
              {/* Compliance */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">5. Compliance and Certifications</h2>
                <p className="mb-4">
              ...
              {/* Incident Response */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">6. Incident Response</h2>
                <p className="mb-4">
                  We have established procedures for responding to security incidents:
                </p>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">6.1 Detection and Response</h3>
                <ul className="list-disc pl-6 mb-4 space-y-2">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">6.2 Notification</h3>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">7. Security Best Practices for Users</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">8. Third-Party Service Security</h2>
                <p className="mb-4">
                  We use trusted third-party services that maintain high security standards:
                </p>
                
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">8.1 Infrastructure Providers</h3>
                <ul className="list-disc pl-6 mb-4 space-y-2">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6 text-[#d7d2cb]">8.2 Service Providers</h3>
                <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              {/* Security Updates */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">9. Security Updates and Maintenance</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">10. Reporting Security Issues</h2>
                <p className="mb-4">
              ...
              {/* Contact */}
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-[#d7d2cb]">11. Contact Us</h2>
                <p className="mb-4">
