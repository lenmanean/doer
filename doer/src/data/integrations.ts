...
export const integrations: IntegrationDefinition[] = [
  ...
  { key: 'asana', name: 'Asana', icon: '🧭', category: 'Task Management', descriptionKey: 'pages.integrations.cards.asana', description: 'Map AI plan milestones into Asana projects so DOER can align its auto-scheduler with project timelines and let collaborators see which AI-scheduled task unlocks the next sprint.' },
  ...
  { key: 'slack', name: 'Slack', icon: '💬', category: 'Communication', descriptionKey: 'pages.integrations.cards.slack', description: 'Slack delivers rich plan digests, lets you ask DOER for a quick auto-reschedule via slash commands, and broadcasts notifications whenever the AI scheduler shifts a milestone.' },
